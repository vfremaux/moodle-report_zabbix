...
class quiz_indicator extends zabbix_indicator {

    static $submodes = 'attemptsinprogress';
    ...
    public function acquire_submode($submode) {
        ...
        switch ($submode) {
            ...
            case 'attemptsinprogress': {
                // Eliminates old attempts that were not completed and stay stucked into database.
                $sql = "
                    SELECT
                        COUNT(*)
                    FROM
