...
class weekly_task extends \core\task\scheduled_task {
    ...
    public function execute() {
        ...
        // Load those indicators that provide weekly period measurement explicitely or implicitely.
        $indicators = report_zabbix_load_indicators('weekly');
