...
class monthly_task extends \core\task\scheduled_task {
    ...
    public function execute() {
        ...
        // Load those indicators that provide monthly period measurement explicitely or implicitely.
        $indicators = report_zabbix_load_indicators('monthly');
