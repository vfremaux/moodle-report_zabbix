...
define(['jquery', 'core/log', 'core/config'], function($, log, cfg) {
    ...
    var reportzabbixpro = {
        ...
        component: 'report_zabbix',
        shortcomponent: 'report_zabbix',
        componentpath: 'report/zabbix',

        init: function() {

            var licensekeyid = '#id_s_' + reportzabbixpro.component + '_licensekey';
            $(licensekeyid).bind('change', this.check_product_key);
            $(licensekeyid).trigger('change');
            log.debug('AMD Pro js initialized for ' + reportzabbixpro.component + ' system');
        },
        ...
        check_product_key: function() {
            ...
            var calculated = reportzabbixpro.checksum(payload);
            ...
            if (crc === calculated) {
                var url = cfg.wwwroot + '/' + reportzabbixpro.componentpath + '/pro/ajax/services.php?';
                url += 'what=license';
                url += '&service=check';
                url += '&customerkey=' + that.val();
                url += '&provider=' + $('#id_s_' + reportzabbixpro.component + '_licenseprovider').val();
