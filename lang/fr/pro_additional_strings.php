...
require_once($CFG->dirroot.'/report/zabbix/lib.php'); // to get xx_supports_feature();
if ('pro' == report_zabbix_supports_feature()) {
    include($CFG->dirroot.'/report/zabbix/pro/lang/fr/pro.php');
}
